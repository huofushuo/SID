...
# OpenAI API Key
API_KEY = "ugSk17yVQiei9e0KDoT5GHBDem51dNWz"
...
def call_api(prompt, image_path):
    ...
    response = requests.post("https://gptproxy.llmpaas.woa.com/v1/chat/completions", headers=headers, json=payload)
...
parser.add_argument("--data-path", type=str, default="/apdcephfs/private_huofushuo/dataset/mscoco/val2014/", help="data path")
